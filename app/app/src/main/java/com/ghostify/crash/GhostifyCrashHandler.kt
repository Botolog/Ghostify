 ...
 *
 * Responsibilities:
 *  1. Map any escaped [Throwable] to a typed [com.ghostify.error.AppError] and hand it to
 ...
 * the next cold start [com.ghostify.recovery.KilledProcessRecovery] resets any in-flight
