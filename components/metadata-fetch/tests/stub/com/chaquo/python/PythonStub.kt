 ...
 * so conversion and failure-mapping logic is verified here, then re-verified
 * on-device against the real interpreter.
 *
 * It models only the surface used by the bridge and PyConverters:
 ...
 * to the right stub handler. Behavior is injectable through `Python.stubModule`
 * so tests can simulate both success results and typed Python failures.
 */
